...
.refund-wrapper
  section.main
    ...
    .highlight
      ...
      | 有機會獲得精美贈品！
    .list
      | 以下資料將用於套組寄送及抽獎，請正確填寫，
      br
      | 抽獎方式將於直播中佈達，請鎖定直播到最後一刻喔！
    .form-box
      label.input-row
        .input-title
          span.red *
      ...
      label.input-row
        .input-title
          span.red *
          p 聯絡手機
        input.input-style(type="text" placeholder="兌換用，請務必輸入真實聯絡手機 (ex:0911222333)" v-model="phone" maxLength="10" @input="checkPhone")
      label.input-row
        .input-title
          span.red *
          p 出生日期
