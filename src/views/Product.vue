...
.product-wrapper
  ...
  section.information
    ...
    .list 3.登入觀看時綁定票券序號請留下正確個人資料，若為非仙妮蕾德會員者套組內除票券外之品項將於直播後郵寄至上述填寫地址，如未完成相關正確填寫資訊，即視同放棄該品項之領取權益，不得異議。若為仙妮蕾德會員者請於購票時填妥正確會員編號，贈品將後續隨貨寄出，若為會員但未完成會員編號填寫者，即視同放棄該品項之領取權益，不得異議。
  section.remark
    p
      | 注意事項：
      br
